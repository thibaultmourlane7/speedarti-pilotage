(() => {
  ...
  window.PILOTAGE_GOOGLE = Object.freeze({
    ...
    linkCalendarEvent: async (eventId, projectClientKey = null, taskClientKey = null) => {
      ...
      return invoke('link_calendar_event', { event_id: eventId, project_client_key: projectClientKey, task_client_key: taskClientKey });
    }
  });
})();
